      ...
      <form>
        ...
        <div class="form-group">
          ...
          <input type="email" class="form-control" placeholder="Correo Electrónico"
                  v-model.lazy="usuario.correo"> <!--Actualiza el campo hasta que salga del input-->
        </div>
        <div class="form-group">
...
export default {
  data(){
    return{
      usuario: { //Agrupa los valores en un objeto.
        nombre : '',
        correo : '',
        clave : '',
        edad : '',
      ...
      paises : ['Argentina','Bolivia','Brasil','Chile','Colombia','Ecuador','España','México','Paraguay','Uruguay','Venezuela']

    }
  },
  methods:{
    enviarFormulario(){
      this.mostrar = true //Muestra el formulario
    }
  }
}
</script>
...
<style>
  .mensaje{ /*Respeta el mensaje cuando haya líneas diferentes*/
    white-space: pre;
  }
</style>
